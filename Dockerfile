...
COPY target /opt/ol/wlp/usr/servers/defaultServer/apps/
RUN mv /opt/ol/wlp/usr/servers/defaultServer/apps/web-application-1.0.0-SNAPSHOT.war /opt/ol/wlp/usr/servers/defaultServer/apps/web-app.war
